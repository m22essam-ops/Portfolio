/* ============================================================
   content.js — everything on this site, in one file.

   Edit it here by hand, or use admin.html (easier).
   Nothing else needs touching. No build step, no npm.

   The rule for images: put the file in the images/ folder and
   write just its name here, e.g. "poster.png". Files pulled from
   the old site live in images/live/, so those read "live/name.jpg".
   A full https:// link works too.
   ============================================================ */
...
window.SITE_CONTENT = {
  ...
  /* ---- THE TICKET (home page) ----------------------------------
     The concept lives here. Every line is yours to rewrite.

     THE AWARDS SWITCH: `awards` is empty, so the site runs the
     "so far" version. The day you win something, add it:

         awards: [ "D&AD Wood Pencil, 2027" ]

     and the home page flips itself to the retraction version
     below (wonBand / wonTitleTop / wonTitleBottom / wonBadge /
     wonLine) and prints what you won. Nothing else to change.
     -------------------------------------------------------------- */
  ticket: {
    ...
    sub: "Mohammed Essam · Cairo → Dubai → Madrid · 2 languages",
    ...
    /* the day the joke stops being true */
    awards: [],
  ...
  /* ---- SUBTLE JOKES -------------------------------------------
     Small places a joke can hide. Leave any of them empty ("")
     and that slot just goes quiet. These are Claude's drafts,
     so rewrite them in your voice or delete them.
     -------------------------------------------------------------- */
  jokes: {
  ...
  work: {
    ...
    /* shown on a project page, under the title */
